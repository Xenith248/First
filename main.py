...
class DiseasePrediction:
    ...
    def __init__(self, model_name=None):
        ...
        try:
            ...
            raise FileNotFoundError("Error reading Config file. Ensure './config.yaml' exists and is formatted correctly.") from e
    ...
    def _load_train_dataset(self):
        ...
        if train_features.shape[1] != 132 or len(train_labels) != train_features.shape[0]:
            raise ValueError("Training data is not properly formatted.")
    ...
    def _load_test_dataset(self):
        ...
        # Check for data sanity
        if test_features.shape[1] != 132 or len(test_labels) != test_features.shape[0]:
            raise ValueError("Test data is not properly formatted.")
    ...
    def _feature_correlation(self, data_frame=None, show_fig=False):
        ...
        if numeric_data.empty:
            raise ValueError("No numeric data available for correlation calculation.")
